...
FILES_ARGS = ['git', 'ls-files', '--',
              ":(exclude)build-aux/m4/",
              ":(exclude)contrib/builder-keys/",
              ...
              ":(exclude)src/crc32c/",
              ":(exclude)src/crypto/",
              ":(exclude)src/ctpl_stl.h",
              ":(exclude)src/cxxtimer.hpp",
              ":(exclude)src/dashbls/",
              ":(exclude)src/immer/",
              ":(exclude)src/leveldb/",
              ...
              ":(exclude)src/util/subprocess.hpp",
              ":(exclude)src/wallet/bip39_english.h"]
