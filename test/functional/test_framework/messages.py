...
class CCbTx:
    __slots__ = ("version", "height", "merkleRootMNList", "merkleRootQuorums", "bestCLHeight", "bestCLSignature", "lockedAmount")

    def __init__(self, version=None, height=None, merkleRootMNList=None, merkleRootQuorums=None, bestCLHeight=None, bestCLSignature=None, lockedAmount=None):
        self.set_null()
