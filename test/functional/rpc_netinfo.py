...
class NetInfoTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Need to restart node with deprecated fields enabled to test shims
        evo_extra_args = self.node_evo.node.extra_args.copy()
        self.restart_node(self.node_evo.mn.nodeIdx, extra_args=evo_extra_args + ['-deprecatedrpc=service'])
        ...
        self.restart_node(self.node_evo.mn.nodeIdx, extra_args=evo_extra_args)
        self.reconnect_nodes()
