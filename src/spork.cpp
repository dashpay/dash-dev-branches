...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_15_DETERMINISTIC_MNS_ENABLED:        r = SPORK_15_DETERMINISTIC_MNS_DEFAULT; break;
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_15_DETERMINISTIC_MNS_ENABLED:        return SPORK_15_DETERMINISTIC_MNS_DEFAULT;
        default:
