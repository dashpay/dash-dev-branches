...
#ifndef BITCOIN_INDEX_TIMESTAMPINDEX_TYPES_H
#define BITCOIN_INDEX_TIMESTAMPINDEX_TYPES_H
...
struct CTimestampIndexIteratorKey {
    ...
    CTimestampIndexIteratorKey() = default;
    explicit CTimestampIndexIteratorKey(uint32_t time) :
        m_time{time}
    {
    }
...
struct CTimestampIndexKey {
    uint32_t m_block_time{0};
    uint256 m_block_hash;

    CTimestampIndexKey() = default;
...
#endif // BITCOIN_INDEX_TIMESTAMPINDEX_TYPES_H
