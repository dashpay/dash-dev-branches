...
void createprovidertx_help() {
    throw std::runtime_error(
            ...
            "\nAvailable types:\n"
            "  createprovidertx register \"collateralAddress\" collateralAmount \"ipAndPort\" protocolVersion masternodeKey payoutAddress\n"
            "      Registers a new masternode on-chain. The resulting transaction will move the specified amount\n"
            "      to the address specified by collateralAddress and will then function as the collateral of your\n"
            "      masternode. The transaction will not be signed, which needs be done manually before it can be\n"
            "      submitted to the network. You can use \"signrawtransaction\" for this.\n"
            ...
            "      5. \"masternodeKey\"       (string, required) The masternode key generated by \"masternode genkey\".\n"
            "                               Must be the same as used by the masternode later.\n"
            "      6. \"payoutAddress\"       (string, required) The dash address to use for masternode reward payments\n"
            "                               Must match \"collateralAddress\"."
            "\nExamples:\n"
           + HelpExampleCli("createprovidertx", "register  \"XwnLY9Tf7Zsef8gMGL2fhWA9ZmMjt4KPwG\" 1000 \"1.2.3.4:1234\" 0 \"93Fd7XY2zF4q9YKTZUSFxLgp4Xs7MuaMnvY9kpvH7V8oXWqsCC1\" XwnLY9Tf7Zsef8gMGL2fhWA9ZmMjt4KPwG")
    );
}
