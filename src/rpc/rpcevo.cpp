...
void protx_register_help() {
    throw std::runtime_error(
            ...
            "5. \"operatorKey\"         (string, required) The operator key generated by \"masternode genkey\".\n"
            "                         Must be the same as used by the masternode later.\n"
            "6. \"ownerKey\"            (string, required) The owner key generated by \"masternode genkey\".\n"
            "                         If set to \"0\" or empty string, operatorKey is used.\n"
...
UniValue protx_register(const JSONRPCRequest& request) {
    ...
    CKey keyOperator = ParsePrivKey(request.params[5].get_str(), false);
    CKey keyOwner = keyOperator;
    if (request.params[6].get_str() != "0" && request.params[6].get_str() != "") {
        keyOwner = ParsePrivKey(request.params[6].get_str(), false);
    }
    ...
    ptx.keyIDOperator = keyOperator.GetPubKey().GetID();
