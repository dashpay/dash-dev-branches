...
static CWallet testWallet(testChain.get(), nullptr /* coinjoin_loader */, "", CreateDummyWalletDatabase());
...
BOOST_AUTO_TEST_CASE(bnb_search_test)
{
    ...
    empty_wallet();
    {
        std::unique_ptr<CWallet> wallet = std::make_unique<CWallet>(m_node.chain.get(), nullptr /* coinjoin_loader */, "", CreateMockWalletDatabase());
