...
void CCoinJoinClientOptions::Init()
{
    ...
    instance.nCoinJoinSessions = std::min(std::max(static_cast<int>(gArgs.GetIntArg("-coinjoinsessions", DEFAULT_COINJOIN_SESSIONS)), MIN_COINJOIN_SESSIONS), MAX_COINJOIN_SESSIONS);
    instance.nCoinJoinRounds = std::min(std::max(static_cast<int>(gArgs.GetIntArg("-coinjoinrounds", DEFAULT_COINJOIN_ROUNDS)), MIN_COINJOIN_ROUNDS), MAX_COINJOIN_ROUNDS);
    instance.nCoinJoinAmount = std::min(std::max(static_cast<int>(gArgs.GetIntArg("-coinjoinamount", DEFAULT_COINJOIN_AMOUNT)), MIN_COINJOIN_AMOUNT), MAX_COINJOIN_AMOUNT);
    instance.nCoinJoinDenomsGoal = std::min(std::max(static_cast<int>(gArgs.GetIntArg("-coinjoindenomsgoal", DEFAULT_COINJOIN_DENOMS_GOAL)), MIN_COINJOIN_DENOMS_GOAL), MAX_COINJOIN_DENOMS_GOAL);
    instance.nCoinJoinDenomsHardCap = std::min(std::max(static_cast<int>(gArgs.GetIntArg("-coinjoindenomshardcap", DEFAULT_COINJOIN_DENOMS_HARDCAP)), MIN_COINJOIN_DENOMS_HARDCAP), MAX_COINJOIN_DENOMS_HARDCAP);
