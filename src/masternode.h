...
struct masternode_info_t
{
    ...
    masternode_info_t(int activeState, int protoVer, int64_t sTime,
        ...
        pubKeyCollateralAddress{pkCollAddr}, pubKeyMasternode{pkMN}, pubKeyIDCollateralAddress{pkCollAddr.GetID()}, keyIDOwner{pkMN.GetID()}, keyIDOperator{pkMN.GetID()}, keyIDVoting{pkMN.GetID()} {}
    ...
    masternode_info_t(int activeState, int protoVer, int64_t sTime,
        ...
        nActiveState{activeState}, nProtocolVersion{protoVer}, sigTime{sTime},
        outpoint{outpnt}, addr{addr},
        pubKeyCollateralAddress{}, pubKeyMasternode{}, pubKeyIDCollateralAddress{pkCollAddr}, keyIDOwner{pkOwner}, keyIDOperator{pkOperator}, keyIDVoting{pkVoting} {}
...
public:
    ...
    static CollateralStatus CheckCollateral(const COutPoint& outpoint, const CKeyID& pubkeyID);
    static CollateralStatus CheckCollateral(const COutPoint& outpoint, const CKeyID& pubkeyID, int& nHeightRet);
